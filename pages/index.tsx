        ...
        <div className=" flex flex-col w-[80%]  ">
          ...
          <div className=" flex justify-evenly my-16">
            <div className=" flex flex-col items-center">
              ...
              <h4  className=" max-w-[200px] text-lg font-medium text-center mt-3">Build a Strong Conceptual Foundation</h4>
            </div>
            <div className=" flex flex-col items-center">
              <img src="assets/home/benefits/benefit2.png" className=" -mb-[60px]" alt="" />
              <h4 className=" max-w-[200px] text-lg font-medium text-center mt-3">Ace Your Career in your Life</h4>
            </div>
            <div className=" flex flex-col items-center">
              <img src="assets/home/benefits/benefit3.png" alt="" />
              <h4 className=" max-w-[200px] text-lg font-medium text-center mt-3">Get Help in your Development</h4>
            </div>
          </div>
      ...
      <section className=" w-full flex flex-col items-center mb-14">
        <div className=" w-4/5 flex flex-col space-y-14 ">
          <div className=" flex flex-col space-y-4">
            ...
            <h2 className=" text-3xl font-medium  text-black text-opacity-60">To help you learn at your own pace</h2>
            <h3 className=" text-xl font-medium  text-black text-opacity-60 max-w-2xl">
              Be an independent self motivated learner. Our Classes are designed to improve your Career Potention many folds
            </h3>
          </div>
          ...
          <div className=" flex items-center justify-evenly">
            ...
            <div>
            <h1 className=" text-3xl font-semibold mb-5">Concept Videos & Cheat Sheet</h1>
            
            <span className="flex">
              <img src="assets/home/resources/rscicon.svg" className=" mr-3" alt="" />
              Short & Crisp videos for better concept clarity
            </span>
            <span className="flex">
              <img src="assets/home/resources/rscicon.svg" className=" mr-3" alt="" />A disciplined approach for self paced coaching
              and improving Skills
            </span>
            <span className="flex">
              <img src="assets/home/resources/rscicon.svg" className=" mr-3" alt="" />A detailed Cheat Sheet to improve Efficiency
          ...
          <div className=" flex items-center justify-evenly">
            ...
            <h1 className=" text-3xl font-semibold mb-5">Test and Smart Results</h1>
            <span className="flex">
              <img src="assets/home/resources/rscicon.svg" className=" mr-3" alt="" />
              Concept-wise Tests
            </span>
          ...
          <div className=" flex items-center justify-evenly">
            ...
            <h1 className=" text-3xl font-semibold mb-5">Doubt`s Resolution</h1>
            <span className="flex">
              <img src="assets/home/resources/rscicon.svg" className=" mr-3" alt="" />
